// rpi_servo_motor_ctrl_01...cpp
// d20m01y2023
//
// NOTE #1: This program is a variant of the previous python
// code (See 'rpi_servo_motor_ctrl_03_d21m10y2022.py') used
// to control the arm of a servo via its duty cycle.
//
// NOTE #2: The numbering system used here is WiringPi, not
// BCM (Paul McWhorter) or BOARD (as in ExplainingComputers)
//
// Again, the python version of this code is courtesy of
// Paul McWhorter (2022), "Raspberry Pi LESSON 19: Simple
// Control of Servo From Raspberry Pi", YouTube.
...
//
// (3.) ExplainingComputers YouTube channel.
//
// Difference(s):
// (1.)
//
