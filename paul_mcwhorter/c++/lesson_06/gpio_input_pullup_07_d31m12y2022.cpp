...
//
// Difference(s):
// (1.) Separate CGPIOSetup class from CGPIOCleanExit class and
//      implement former to be more representative of ongoing developments.
//
// (2.)
//
//
...
class CGPIOSetup
{
    public:
        // (See Teach Yourself C++ in 21 days, www.101.lv/learn/C++/htm/):
        CGPIOSetup();                 // Constructor prototype
...
CGPIOSetup::CGPIOSetup()
{
    ...
    m_PinNumber = 29;            // To properly intialize class member data
}
