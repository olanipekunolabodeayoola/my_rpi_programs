...
//
// Difference(s):
// (1.) Unlike gpio_input_pullup_01_d30m12y2022.cpp
// incoporates LED circuit
// (2.) Changes signal handler name from cleanup() to cKeyboardInterrupt()
//
#include <iostream>
#include <wiringPi.h>
#include <signal.h>
