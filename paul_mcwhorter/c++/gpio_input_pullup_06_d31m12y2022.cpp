...
//
// Difference(s):
// (1.) To modify class CleanupGPIOPin header name to CGPIOCleanExit
//
// (2.)
//
//
...
ULONG CGPIOCleanExit::getInputPin() const
{
    return m_PinNumber;
}

// setOutputPin public accessor fxn defn:
void CGPIOCleanExit::setInputPin(int pinNumber)
{
...
int main(void)
{
    ...
    CGPIOCleanExit Pins[totalPins - 1];   // Declare array of size =
