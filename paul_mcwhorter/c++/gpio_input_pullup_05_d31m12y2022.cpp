...
// pn1 = 29 corresponds to GPIO wiringPi pin #29)
// WARNING: Check GPIO pin is safely connected!
CleanupGPIOPin::CleanupGPIOPin()
{
    cout << "CleanupGPIOPin constructor initialized...\n";
...
CleanupGPIOPin::~CleanupGPIOPin()
{
    ...
    cout << "CleanupGPIOPin destructor Initialized...\n";
}
...
ULONG CleanupGPIOPin::getInputPin() const
{
    return m_PinNumber;
}

// setOutputPin public accessor fxn defn:
void CleanupGPIOPin::setInputPin(int pinNumber)
{
...
int main(void)
{
    ...
    int totalPins = 2;    // Total number of pins

    CleanupGPIOPin Pins[totalPins - 1];    // Define array of size =
