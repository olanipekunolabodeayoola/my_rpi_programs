# rpi_servo_motor_ctrl_02_d21m10y2022.py
# Courtesy ExplainingComputers YouTube channel.
# Modify while loop to rectify jitter of servo
# arm (Same is also applied to other relevant
# portions of code)
#
# Import Libraries:
...
servo1.ChangeDutyCycle(0)    # Not sure what this parameter "0"
			     ...
			     # Update: It is to stop servo arm
			     # from moving by sending '0' as signal
